...
def handle_weather(message):
    try:
        ...
        # Use OpenWeatherMap Geocoding API for fuzzy matching
        ...
        button = InlineKeyboardButton(text="🔮 5-Day Forecast", callback_data=f"forecast:{city_name}")
        keyboard.add(button)
...
def handle_forecast_callback(call):
    ...
    try:
        ...
        for i in range(0, 40, 8):  # Approx. once per day
            entry = data["list"][i]
